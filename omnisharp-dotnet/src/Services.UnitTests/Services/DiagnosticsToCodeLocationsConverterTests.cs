...
namespace SonarLint.OmniSharp.Plugin.UnitTests.Services
{
    ...
    public class DiagnosticsToCodeLocationsConverterTests
    {
        ...
        private void AssertLocation(ICodeLocation codeLocation, FileLinePositionSpan location)
        {
        ...
        private FileLinePositionSpan CreateLocationSpan(string fileName, int startLine, int column, int endLine, int endColumn) =>
            new(fileName, CreateLinePositionSpan(startLine, column, endLine, endColumn));

        private LinePositionSpan CreateLinePositionSpan(int startLine, int column, int endLine, int endColumn) =>
            new(new LinePosition(startLine, column), new LinePosition(endLine, endColumn));
        
        private Location CreateAdditionalLocation(string filePath, LinePositionSpan span) => 
        ...
        private DiagnosticsToCodeLocationsConverter CreateTestSubject() => new();
    }
}